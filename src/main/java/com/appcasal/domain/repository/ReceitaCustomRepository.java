...
import com.appcasal.domain.repository.utils.MapCampoFilter;
import com.appcasal.domain.repository.utils.MapCampoUtil;
...
public class ReceitaCustomRepository {
    ...
    public List<Receita2> filterCustomizado(Integer id,
                                            String descricao,
                                            BigDecimal valorDe,
                                            BigDecimal valorAte){
